...
def fix_Yahoo_returning_live_separate(quotes, interval, tz_exchange, prepost, repair: bool = False, currency=None): ...
...
class ProgressBar:
    ...
    def animate(self, iteration=None) -> None: ...
    def update_iteration(self, val=None) -> None: ...
